...
Most of these come down to network reality or how gitee serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

gitee rate-limits like any public site. gitee already paces
...
Where a surface is gated, gitee reads a cookie or token you supply
...
`gitee`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what gitee actually did
